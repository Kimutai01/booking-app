...
class BusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus" do
    assert_difference("Bus.count") do
      post buses_url, params: { bus: { capacity: @bus.capacity, date: @bus.date, departing_time: @bus.departing_time, from: @bus.from, registration: @bus.registration, to: @bus.to } }
    end
  ...
  test "should update bus" do
    patch bus_url(@bus), params: { bus: { capacity: @bus.capacity, date: @bus.date, departing_time: @bus.departing_time, from: @bus.from, registration: @bus.registration, to: @bus.to } }
